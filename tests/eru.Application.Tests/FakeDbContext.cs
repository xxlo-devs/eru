    ...
    public sealed class FakeDbContext : DbContext, IApplicationDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Class>()
                ...
                .HasMaxLength(255);
            modelBuilder.Entity<Class>()
                .HasData(new Class("I a", Year.Freshman), new Class("II b", Year.Sophomore), new Class("III c", Year.Junior));
            ...
            modelBuilder.Entity<User>()
                .HasData(
                    ...
                    new User { Id = "7124C49B-B04A-468F-A946-40025B19FF91", Platform = Platform.DebugMessageService, Stage = Stage.GatheredClass, Year = Year.Sophomore, Class = "II b"},
                    new User { Id = "380AE765-803D-4174-A370-1038B7D53CD6", Platform = Platform.DebugMessageService, Stage = Stage.Subscribed, Year = Year.Junior, Class = "III c"},
