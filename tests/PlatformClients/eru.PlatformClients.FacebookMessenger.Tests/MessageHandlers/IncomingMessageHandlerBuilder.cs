    ...
    internal class IncomingMessageHandlerBuilder
    {
        ...
        private IServiceProvider BuildServiceProvider()
        {
            ...
            serviceProviderMock
                ...
                .Returns(MockBuilder.BuildMediatorMock().Object);
            serviceProviderMock
                .Setup(x => x.GetService(typeof(IRegistrationDbContext)))
                .Returns(new FakeRegistrationDb());
            serviceProviderMock
                .Setup(x => x.GetService(typeof(IKnownUserMessageHandler)))
                .Returns(KnownUserMessageHandlerMock.Object);
            serviceProviderMock
                .Setup(x => x.GetService(typeof(IRegisteringUserMessageHandler)))
                .Returns(RegisteringUserMessageHandlerMock.Object);
            serviceProviderMock
                .Setup(x => x.GetService(typeof(IUnknownUserMessageHandler)))
                .Returns(UnknownUserMessageHandlerMock.Object);
